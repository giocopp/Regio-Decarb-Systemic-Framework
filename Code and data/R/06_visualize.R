...
plot_radar_charts <- function(risk_data, output_dir) {
  ...
  radar_vars <- c(
    ...
    "Vuln_Technology", "Vuln_Finance", "Vuln_Institutions",
    "Vuln_Diversification"
  )
  radar_labels <- c(
    "Exposure",
    "Energy", "Labour", "Supply Chain",
    "Technology", "Finance", "Institutions",
    "Diversification"
  )
